...
public class AccessibilityTest4 extends Baseclass2 {
	...
	public BufferedImage takeScreenshot(WebElement textView) throws IOException {
	    ...
	    private AxeView createAxeViewForTextView(WebElement textView,ColorContrastResult contrastResult) {
	        ...
	        return new AxeView.Builder() {
				...
				public AxeColor textColor() {
					// TODO Auto-generated method stub
					return contrastResult.getMostLikelyTextColor();
				}
	        }.build();
	    }
    ...
    {
    	WebElement textView = driver.findElement(By.xpath("//android.widget.Button[1]"));
    	System.out.println(textView.getAttribute("className"));
    	...
    	System.out.println(textViews.size()+" "+ buttons.size()+" "+ imagebuttons.size()+" "+ allImageElements.size()+ " " +  editTextFields.size()+" "+ listViews.size()+" "+  gridViews.size()+" "+ recyclerViews.size());*/
    	AxeDevice axeDevice =createAxeDevice(driver);
    	Axe axe =new Axe (new AxeConf());
    	BufferedImage image = takeScreenshot(textView);
    	String filePath = "C://Users//hdu//eclipse//Espresso//src//test//java//resources//screenshot.png";
        ...
        Dimension sizeInDp = AccessibilityTest4.getSizeInDp(textView, 420);
        System.out.println("Width in dp: " + sizeInDp.getWidth());
        System.out.println("Height in dp: " + sizeInDp.getHeight());

		AxeView axeView = createAxeViewForTextView(textView,contrastResult);
        ...
        processAxeResults(axeResult,textView,contrastRatio);
    	/*List<WebElement> textViews = driver.findElements(By.className("android.widget.TextView"));
